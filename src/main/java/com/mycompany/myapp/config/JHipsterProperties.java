...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "ecofruit@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "ecofruit API";

        private String description = "ecofruit API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "ecofruit";
