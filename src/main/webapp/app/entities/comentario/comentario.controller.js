(function() {
    ...
    ComentarioController.$inject = ['$scope', '$state', 'DataUtils', 'Comentario', 'ComentarioSearch', 'ParseLinks', 'AlertService', 'pagingParams', 'paginationConstants'];
